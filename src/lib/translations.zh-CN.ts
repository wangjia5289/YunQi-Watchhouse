const zh: Record<string, string> = {
  ...
  "Apply mode": "应用方式",
  "Replace project and tags": "替换项目和标签",
  "Add selected tags": "添加所选标签",
  "Remove selected tags": "移除所选标签",
  ...
  "Added activity tags": "已添加活动标签",
  "Removed activity tags": "已移除活动标签",
...
const replacements: Array<[RegExp, (match: RegExpMatchArray) => string]> = [
  ...
  [/^Added tags to (\d+) sessions\.$/, (m) => `已为 ${m[1]} 个会话添加标签。`],
  [/^Removed tags from (\d+) sessions\.$/, (m) => `已从 ${m[1]} 个会话移除标签。`],
